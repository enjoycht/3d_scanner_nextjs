                    ...
                    <InputGroup className='mx-2'>
                        {
                            ...
                            (status === "start" || status === "scan" ) ?
                                ...
                                <InputGroup.Text className='text-success'>掃描中</InputGroup.Text> :

                            (status === "stop") ?

                                <InputGroup.Text className='text-warning'>暫停掃描</InputGroup.Text> :

                            (status === "end") ?

                                <InputGroup.Text className='text-info'>結束掃描</InputGroup.Text> :
